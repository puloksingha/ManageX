            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <p className="truncate text-sm font-semibold text-slate-900 dark:text-slate-100">{row.student?.name || "-"}</p>
                  <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">{row.assignment?.title || "-"}</p>
                </div>
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <div>
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Marks</p>
                  <p className="mt-1 text-sm font-semibold text-slate-800 dark:text-slate-100">{row.marks ?? "-"}</p>
                </div>
                <div>
